...
jQuery(document).ready(function(){
	...
	//Home Page
	demo_panel.append('<ul class="page-version clearfix"><p>Version</p><select class="styled" onChange="window.document.location.href=this.options[this.selectedIndex].value;" value="GO"><option selected="selected">select version</option><option value="index.html">One Page</option><option value="index2.html">Business Version</option><option value="index3.html">Video Background</option><option value="index4.html">Full Screen Parallax Slider</option><option value="../multipage/index.html">Multipage Version</option><option value="../coming-soon/index.html">Coming Soon</option></select></ul>');
